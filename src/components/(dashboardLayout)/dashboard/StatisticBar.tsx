...
const StatisticBar = () => {
  return (
    <div className="h-32 flex  font-roboto text-primary-white">
      <div className="w-1/2 h-full mr-4 bg-primary-green rounded-xl flex gap-6 px-12 items-center ">
      ...
      <div className="w-1/2 h-full ml-4 bg-primary-green rounded-xl flex gap-6  px-12 items-center  ">
        <div className="bg-primary-black p-4 rounded-full">
